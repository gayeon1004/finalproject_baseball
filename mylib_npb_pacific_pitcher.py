...
def npb_pacific_pitcher():
    ...
    # 데이터 전달
    data = {'uCategory':'wbaseball','category':'npb', 'league':'PL', 'year':'2023','pFlag':'pitcher','order':'AVG'}
    ...
    if response.status_code == 200:
        ...
        for i in dict_example:
            m_list.append((i['teamName'], i['playerName'], i['ERA'], i['W'], i['SV'], i['SO'], i['H'], i['WHIP']))
